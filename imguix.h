...
ES2INL(FRC) OptVal_t<bool> Checkbox(const char* label, bool v)
{
  OptVal_t<bool> ret;
...
ES2INL(FRC) OptVal_t<int32_t> InputInt(const char* label, int32_t v, int step = 1, int step_fast = 100, ImGuiInputTextFlags flags = 0)
{
...
ES2INL(FRC) OptVal_t<float[3]> InputFloat3(const char* label, const float v[3], const char* format = "%.3f", ImGuiInputTextFlags flags = 0)
{
...
ES2INL(FRC) OptVal_t<int32_t> DragInt(const char* label, int32_t v, float v_speed = 1.0f, int v_min = 0, int v_max = 0, const char* format = "%d")
{
  OptVal_t<int32_t> ret;
...
ES2INL(FRC) OptVal_t<float> DragFloat(const char* label, float v, float v_speed = 1.0f, float v_min = 0.0f, float v_max = 0.0f, const char* format = "%.3f", float power = 1.0f)
{
  OptVal_t<float> ret;
